...
const StrengthProductSection: React.FC<ProductSectionProps> = ({sectionId}) => {
    return (
        <section id={sectionId} className="relative flex flex-col gap-8 w-full justify-center items-center p-12 bg-ivoryWhite">
          <h2 className="text-charcoalBlack text-3xl lg:text-5xl font-bold text-center uppercase"><span className="text-blue-500">Transform </span>Strength Training with <span className="text-blue-500">Premium</span> Equipment</h2>
