...
const CardioProductSection: React.FC<ProductSectionProps> = ({sectionId}) => {
    return (
        ...
        <section id={sectionId} className="relative flex flex-col gap-8 w-full justify-center items-center px-12 lg:px-48 py-8 bg-charcoalBlack">
          <h2 className="text-white text-2xl lg:text-5xl font-bold text-center uppercase"><span className="text-blue-500">Elite</span> Cardio Machines, <span className="text-blue-500">Unmatched</span> Quality</h2>
